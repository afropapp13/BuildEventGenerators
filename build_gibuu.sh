...
# For fields x, y, z, you need to go back to your GiBUU build and instead of make buildRootTuple, do make buildRootTuple_POS  (version of the ntupler with the vtx location w/in the nucleus)
